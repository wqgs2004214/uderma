...
public class WeixinController {
	...
	public WeixinUserServiceI getWeixinUserService() {
	...
	public String listUser(Model model) {
		System.out.println("==================================================================================");
		List <MUser> list = weixinUserService.getAll();
	...
	public String updateUserUI(String id, HttpServletRequest request) {
		MUser muser = weixinUserService.selectByPrimaryKey(id);
	...
	public String updateUser(MUser muser) {
		weixinUserService.update(muser);
